"""
SimpleRunner v0.3 — Skill execution for simple mode projects.

This is the legacy v0.3 SkillRunner, refactored for simple mode in Phase 3.
"""
...
class SimpleRunner(BaseRunner):
    """
    Legacy v0.3 runner for simple mode projects.
    
    This class maintains backward compatibility with v0.3 while
    inheriting from BaseRunner for Phase 2+ architecture.
    """
    ...
    def run(self, skill_name: str, **kwargs) -> None:
        ...
        Args:
            ...
            **kwargs: Additional arguments for the skill (e.g., phase).
        """
        # Extract phase from kwargs for backward compatibility
